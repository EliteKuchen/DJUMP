...
MACRO_CONFIG_INT(sv_pickup_respawn, 0, 0, 10, CFGFLAG_SERVER, "Time before a pickup respawn")
...
MACRO_CONFIG_INT(sv_leben, 600, 0, 10000, CFGFLAG_SERVER, "")
MACRO_CONFIG_INT(sv_autojump, 1, 0, 1, CFGFLAG_SERVER, "")
